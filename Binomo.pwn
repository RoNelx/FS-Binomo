//Siapa sini cita citanya pas besar ingin main BINOMO ?? agar memajukan generasi anak muda.
#define FILTERSCRIPT
#include <a_samp>
#include <a_graphfunc>
#include <zcmd>
...
CMD:stoptrading(playerid, params[])
{
...
CMD:tradingchart(playerid, params[])
{
